...
export default function TroubleshootingMindset() {
  return (
    <section className="section-shell py-28">
      ...
      <div className="mt-10 overflow-x-auto card-glow rounded-xl border border-white/10 bg-card p-8">
        <ArchitectureDiagram nodes={flow} direction="horizontal" />
      </div>

      <div className="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div className="card-glow rounded-xl border border-white/10 bg-card p-7">
